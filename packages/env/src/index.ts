...
export const env = createEnv({
  server: {
    ...
    R2_BUCKET_ACCESS_KEY: z.string().min(1),
    R2_BUCKET_SECRET_KEY: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    R2_BUCKET_ACCESS_KEY: process.env.R2_BUCKET_ACCESS_KEY,
    R2_BUCKET_SECRET_KEY: process.env.R2_BUCKET_SECRET_KEY,
  },
});
